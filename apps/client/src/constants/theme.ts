...
import { COLOR_TOKENS, DARK_COLOR_TOKENS } from './theme-static';
...
export const Colors = {
  light: {
    ...COLOR_TOKENS,
    activeIndicator: COLOR_TOKENS.tint,
    tabIconDefault: COLOR_TOKENS.icon,
    tabIconSelected: COLOR_TOKENS.accent,
  },
  dark: {
    ...DARK_COLOR_TOKENS,
    activeIndicator: DARK_COLOR_TOKENS.tint,
    tabIconDefault: DARK_COLOR_TOKENS.icon,
    tabIconSelected: DARK_COLOR_TOKENS.accent,
  },
};
