...
export const AppState = { currentState: "active" as const, addEventListener: () => ({ remove() {} }) };
...
export const StyleSheet = { create: <T extends object>(styles: T): T => styles, flatten: (style: unknown) => style, hairlineWidth: 1 };
export const LayoutAnimation = { configureNext: (_config?: unknown, callback?: () => void) => callback?.(), create: () => ({}) };
