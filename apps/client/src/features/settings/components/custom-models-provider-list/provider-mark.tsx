...
export function ProviderMark({
  ...
  return <div className={"" + " " + ""}>
      {provider ? <LobeProviderIcon provider={provider} size={18} type="mono" color="#000000" /> : brand ? <ProviderIcon provider={brand} size={17} color="#000000" /> : <span className={"" + " " + ""}>{initial}</span>}
    </div>;
}
