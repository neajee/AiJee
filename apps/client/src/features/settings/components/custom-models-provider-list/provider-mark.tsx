...
export function ProviderMark({
  ...
  return <div className={toTailwind([providerPageStyles.mark, {
    backgroundColor: colors.accentBg
  }])}>
      {provider ? <LobeProviderIcon provider={provider} size={18} type="mono" color="#000000" /> : brand ? <ProviderIcon provider={brand} size={17} color="#000000" /> : <span className={toTailwind([providerPageStyles.markText, {
