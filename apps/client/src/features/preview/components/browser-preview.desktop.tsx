...
export function BrowserPreviewDesktop({
  serverUrl,
  accessToken,
  sessionId,
  target
  ...
  const targetUrl = useMemo(() => buildPreviewUrl({
    serverUrl,
    sessionId,
    target
  ...
  return <div className="flex flex-col">
    {frame ? <img src={frame} alt={`Preview ${target.label}`} className="flex flex-col" onClick={event => {
