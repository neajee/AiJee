...
export function BrowserPreview({
  ...
  return <div style={styles.container}>
      <iframe key={key} src={src} title={`Preview ${target.label}`} style={iframeStyle as React.CSSProperties} sandbox="allow-same-origin allow-scripts allow-forms allow-modals allow-popups allow-downloads" allow="clipboard-read; clipboard-write" />
    </div>;
}
const styles = {
  container: {
