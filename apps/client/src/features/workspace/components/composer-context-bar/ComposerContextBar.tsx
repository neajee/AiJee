...
export function ComposerContextBar() {
  ...
  return <>
      ...
      <BranchDialog visible={newBranchVisible} currentBranch={currentBranch} branchName={newBranchName} busy={busy} error={branchError} setBranchName={setNewBranchName} onClose={() => setNewBranchVisible(false)} onCreate={() => void handleCreateBranch()} />
    </>;
}
