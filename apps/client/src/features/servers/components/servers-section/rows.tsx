  ...
  return (
    <View style={styles.serverRowWrap}>
      ...
      <Pressable
        ...
        hitSlop={8}
        style={({ pressed, hovered: moreHovered, focused }: any) => [styles.moreAction, (hovered || pressed || moreHovered || focused || false) && { opacity: 1 }, (pressed || moreHovered || focused) && { backgroundColor: p.pressed }, focused && { outlineWidth: 2, outlineColor: p.accent, outlineOffset: 2 } as any]}
      >
