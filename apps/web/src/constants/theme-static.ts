...
export const THEMES = {
  light: {
    ...
    colorHover: COLOR_TOKENS.text,
    colorPress: COLOR_TOKENS.text,
  },
  dark: {
    ...DARK_COLOR_TOKENS,
    color: DARK_COLOR_TOKENS.text,
    colorHover: DARK_COLOR_TOKENS.text,
    colorPress: DARK_COLOR_TOKENS.text,
  },
} as const;
