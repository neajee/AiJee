...
import { useAudioRecorder, useAudioRecorderState, RecordingPresets, AudioModule, setAudioModeAsync } from '@/platform/audio';
...
export function useSpeechRecognition(
  ...
  // --- API mode on native: use @/platform/audio useAudioRecorder ---
