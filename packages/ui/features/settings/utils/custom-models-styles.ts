...
export const providerPageStyles = StyleSheet.create({
  ...
  inlinePanel: { borderTopWidth: StyleSheet.hairlineWidth, padding: 16, gap: 14, backgroundColor: 'rgba(127,127,127,0.045)' },
  modalPanel: { width: '100%', maxWidth: 520, borderWidth: StyleSheet.hairlineWidth, borderRadius: 12, overflow: 'hidden', boxShadow: '0 12px 36px rgba(0,0,0,.28)' } as any,
  modalHeader: { minHeight: 58, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: StyleSheet.hairlineWidth },
  ...
  authMode: { alignSelf: 'flex-start', flexDirection: 'row', borderWidth: StyleSheet.hairlineWidth, borderRadius: 7, padding: 2, gap: 2 },
  authModeItem: { minHeight: 30, paddingHorizontal: 10, borderRadius: 5, alignItems: 'center', justifyContent: 'center' },
  ...
  addModelButton: { minHeight: 32, borderWidth: StyleSheet.hairlineWidth, borderRadius: 7, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 },
