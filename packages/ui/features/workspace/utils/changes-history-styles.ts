...
export const styles = StyleSheet.create({
  ...
  logHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 10, height: 26 },
  ...
  binLabel: { fontSize: 10, fontFamily: Fonts.sansSemiBold, textTransform: 'uppercase', letterSpacing: 0.4, paddingHorizontal: 10, paddingTop: 8, paddingBottom: 2 },
  ...
  entryBody: { flex: 1, paddingVertical: 3 },
