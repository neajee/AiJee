...
export const styles = {
  ...
  inputRow: { flexDirection: 'row', alignItems: 'center', height: 42, borderRadius: 8, borderWidth: 0.633, paddingLeft: 12 , paddingRight: 12 },
  ...
  cancelButton: { height: 36, paddingLeft: 16, paddingRight: 16, borderRadius: 8, borderWidth: 0.633, alignItems: 'center', justifyContent: 'center' },
  cancelText: { fontSize: 14, fontFamily: Fonts.sansMedium },
  saveButton: { height: 36, paddingLeft: 20, paddingRight: 20, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  ...
  sheetTitle: { fontSize: 17, fontFamily: Fonts.sansSemiBold, paddingLeft: 20, paddingRight: 20, paddingBottom: 16 },
  sheetBody: { maxHeight: 300 },
  sheetBodyContent: { paddingLeft: 20, paddingRight: 20, paddingBottom: 4 },
} as const;
